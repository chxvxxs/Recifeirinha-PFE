...
export default function LoginVendedorPage() {  const [formData, setFormData] = useState({
    email: "",
    password: "",
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!res.ok) {
        if (res.status === 404) {
          setError("Vendedor não encontrado. Verifique seu e-mail.");
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <a className="text-sm text-[#FF5258] hover:text-[#D1495B] font-medium transition-colors duration-200">
                    Esqueceu a senha?
                  </a>
                </div>
