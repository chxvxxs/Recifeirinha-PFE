...
export default function PerfilVendedorPage() {
  ...
  const handleSaveEdit = async () => {
    try {
      const res = await fetch(`${API_URL}sellers/update/${sellerId}`, {
        method: "PUT",
        headers: {
  ...
  const handleDeleteAccount = async () => {
    const confirmDelete = window.confirm("Tem certeza que deseja excluir sua conta? Essa ação é irreversível.");
    if (!confirmDelete) return;

    try {
      const res = await fetch(`${API_URL}sellers/delete/${sellerId}`, {
        method: "DELETE",
      });
                ...
                <div className="bg-white rounded-lg shadow-sm border p-6">
                  <div className="flex justify-between items-center mb-6">
                    ...
                    {!isEditing ? (
                      ...
                      <div className="space-x-2">
                        <Button variant="outline" onClick={handleSaveEdit}>Salvar</Button>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <Input
                        name="name"
                        value={isEditing ? editedSeller.name : seller?.name || ""}
                    ...
                    <div>
                      ...
                      <Input
                        name="storeName"
                        value={isEditing ? editedSeller.storeName : seller?.storeName || ""}
                        onChange={isEditing ? handleInputChange : undefined}
                        readOnly={!isEditing}
                        className="mt-1"
                      />
                    ...
                    <div>
                      ...
                      <Input
                        name="email"
                        value={isEditing ? editedSeller.email : seller?.email || ""}
                        onChange={isEditing ? handleInputChange : undefined}
                        readOnly={!isEditing}
                        className="mt-1"
                      />
                    ...
                    <div>
                      ...
                      <Input
                        name="phone"
                        value={isEditing ? editedSeller.phone : seller?.phone || ""}
                        onChange={isEditing ? handleInputChange : undefined}
                        readOnly={!isEditing}
                        className="mt-1"
                      />
                    ...
                    <div>
                      ...
                      <Input
                        name="cnpj"
                        value={isEditing ? editedSeller.cnpj : seller?.cnpj || ""}
                        onChange={isEditing ? handleInputChange : undefined}
                        readOnly={!isEditing}
                        className="mt-1"
                      />
                    ...
                    <div>
                      ...
                      <Input
                        name="category"
                        value={isEditing ? editedSeller.category : seller?.category || "Artesanato"}
                        onChange={isEditing ? handleInputChange : undefined}
                        readOnly={!isEditing}
                        className="mt-1"
                      />
                  ...
                  <div className="mt-6 pt-6 border-t border-gray-200">
                    <button
                      ...
                      className="flex items-center text-gray-600 hover:text-red-700 hover:bg-red-50 p-2 rounded transition-colors duration-200"
                    >
